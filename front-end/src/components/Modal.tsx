    ...
    <>
        {isToggle ? (
            ...
            <div className='size-100 z-2  top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 bg-white/25 shadow-[0_8px_32px_0_rgba(31,38,135,0.37)] backdrop-blur-[12.5px] rounded-[10px] border border-white/20  rounded-md p-12 fixed'>
                <span onClick={handleToggle} className='absolute top-3 left-91 cursor-pointer'><CloseIcon/></span>
                ...
                <button onClick={handleSubmit} className=' mt-3 mb-3 text-white bg-purple-600 px-5 py-2 rounded-xs ml-2'>Submit</button>
            </div>
            </>
        ) : null}
    </>
